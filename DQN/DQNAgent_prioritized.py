...
from utility.PriorityReplayBuffer import PriorityReplayBuffer
import torch
...
class Agent:
    ...
    def calculate_loss_no_grade(self, states, actions, rewards, next_states, dones):
        """
        ...
        """
        tmp = self.q_network(states).detach()
